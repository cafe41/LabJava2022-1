...
public class Menu {
    ...
    public static void menuPrincipal() {
        //"game" es el estado del juego, se irá pasando entre métodos
    ...
    private DobbleGame menuMazoDeCartas(DobbleGame game) {
        ...
        while (election != 0){
            ...
            if (election == 1 && game.getMazoCartas() == null) { //Crear mazo
                ...
                else if (election == 3) { //En caso de que el largo de cardsSet sea 0
    ...
    private DobbleGame optionCrearMazo(DobbleGame game){
        ...
        //Basándonos en el orden generamos el resto de atributos del cardsSet
        int numE = entradaEscaner.nextInt(); //Número de elementos en una carta, entregado por usuario
        int orden = numE - 1;                //"Orden" del cardsSet
    ...
    private DobbleGame optionEliminarJugador(DobbleGame game) {
        ...
        //Solo se ejecuta si la partida aún no ha iniciado (game.modoDeJuego = null)
